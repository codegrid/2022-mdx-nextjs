import { MyLayout } from '../layouts/MyLayout.jsx' // 追加
import { RankingTable } from '../components/RankingTable.jsx'

export const meta = { title: '10月のお気に入り数ランキング' } // 追加
...
{/* 最後にレイアウト用コンポーネントにメタデータを渡し、コンテンツをラップしてexport */}
export default ({ children }) => <MyLayout meta={meta}>{children}</MyLayout>
